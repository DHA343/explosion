...
@export_range(0.0, 1.0, 0.01, "suffix:s") var body_scale_duration: float = 0.6
@export var body_scale_transition: Tween.TransitionType = Tween.TRANS_EXPO
@export var body_scale_ease: Tween.EaseType = Tween.EASE_OUT
